...
const srcFilePath = resolve(__dirname, '../../../tailwind.config.js'); // Adjust this path as needed

// List your destination paths here
const commonDestPath = (project) => resolve(__dirname, `../../../../${project}/tailwind.config.js`);
