...
const srcPath = resolve(__dirname, '../../assets/commons/theme/tailwind'); // Adjust this path as needed

// List your destination paths here
const commonDestPath = (project) => resolve(__dirname, `../../../../${project}/src/assets/commons/theme/tailwind`);
